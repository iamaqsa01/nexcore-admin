...
export default function ClientsError({
  ...
  useEffect(() => {
    console.error("Clients page failed to load:", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 rounded-lg border border-dashed border-border bg-card/50 px-6 py-16 text-center">
      ...
      <div className="space-y-1">
        <h3 className="text-sm font-semibold">Couldn&apos;t load clients</h3>
        <p className="mx-auto max-w-md text-sm text-muted-foreground">
          The clients directory is temporarily unavailable. This is usually a
